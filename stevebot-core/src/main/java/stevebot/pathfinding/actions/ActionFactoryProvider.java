...
import stevebot.pathfinding.actions.playeractions.ActionBridgeFree;
import stevebot.pathfinding.actions.playeractions.ActionDigDown;
import stevebot.pathfinding.actions.playeractions.ActionDropDown;
import stevebot.pathfinding.actions.playeractions.ActionEnterWater;
import stevebot.pathfinding.actions.playeractions.ActionExitWater;
import stevebot.pathfinding.actions.playeractions.ActionFall;
import stevebot.pathfinding.actions.playeractions.ActionJump;
import stevebot.pathfinding.actions.playeractions.ActionMineDown;
import stevebot.pathfinding.actions.playeractions.ActionMineStraight;
import stevebot.pathfinding.actions.playeractions.ActionMineUp;
import stevebot.pathfinding.actions.playeractions.ActionPassDoor;
import stevebot.pathfinding.actions.playeractions.ActionPillarUp;
import stevebot.pathfinding.actions.playeractions.ActionPillarUpMine;
import stevebot.pathfinding.actions.playeractions.ActionSprintJump;
