...
public class PlayerInputImpl implements PlayerInput {
    ...
    @Override
    public EventListener<TickEvent.PlayerTickEvent> getPlayerTickListener() {
        return listenerPlayerTick;
    }


    @Override
    public EventListener<ConfigChangedEvent.PostConfigChangedEvent> getConfigChangedListener() {
